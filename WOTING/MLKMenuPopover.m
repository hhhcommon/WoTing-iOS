...
@property(nonatomic,retain) NSArray *menuItemsImgV;
...
- (id)initWithFrame:(CGRect)frame menuItems:(NSArray *)aMenuItems AndmenuItemImgv:(NSArray *)menuItemImgV
{
    ...
    if (self)
    {
        ...
        self.menuItemsImgV = menuItemImgV;
        ...
        UIImageView *menuPointerView = [[UIImageView alloc] init];        menuPointerView.image = [UIImage imageNamed:@"options_pointer"];
        menuPointerView.tag = MENU_POINTER_TAG;
        [self.containerButton addSubview:menuPointerView];
        [menuPointerView mas_makeConstraints:^(MASConstraintMaker *make) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.imageView.image = [UIImage imageNamed:[self.menuItemsImgV objectAtIndex:indexPath.row]];
