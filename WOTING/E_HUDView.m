...
+ (void)showMsg:(NSString *)msg inView:(UIView*)theView{
    ...
    E_HUDView *alert = [[E_HUDView alloc] initWithMsg:msg andView:theView];
    if (!theView){
...
- (id)initWithMsg:(NSString*)_msg andView:(UIView *)view{
    ...
    if (self = [super init]) {
        ...
        [labelText setFrame:CGRectMake((160 - textSize.width) / 2, 18 + 50,textSize.width, textSize.height)];
        [self  addSubview:labelText];
        self.layer.cornerRadius = 10;
        
        UIView *View = view;
        View.frame = CGRectMake(110/2,0,50, 50);
